...
<body>
    ...
    <div class="app-container">
            ...
            <div class="header-top-row">
                <div class="brand-section">
                    ...
                    <div class="brand-info">
                        <h1 data-i18n="app_title">DX Plan</h1>
                        <p data-i18n="app_subtitle">Tablero de Seguimiento Estratégico</p>
                    </div>
                    <!-- Active Users Panel -->
                    <div id="active-users-container" class="active-users-container" style="display: none;">
                        <span class="online-pulse"></span>
                        <span id="active-users-list" data-i18n="online_users_loading">Conectados: ...</span>
                    </div>
                </div>
                
                <div class="user-settings-section">
                    <div id="user-badge-container" class="user-badge-container" style="display: none;"></div>
                    <select id="role-selector" class="select-filter" style="min-width: auto; padding-right: 1.5rem; background-position: right 0.35rem center; margin-right: 0.5rem;" title="Cambiar Rol de Usuario">
                        <option value="admin" data-i18n="role_admin">✏️ Editor</option>
                        <option value="collaborator" data-i18n="role_collaborator">👥 Colaborador</option>
                        <option value="viewer" data-i18n="role_viewer">👁️ Visor</option>
                    </select>
                    <button class="btn" id="btn-lang-toggle" title="Cambiar Idioma / Switch Language">
                        <i data-lucide="languages"></i> <span id="lang-label">EN</span>
                    </button>
                    <button class="btn" id="btn-fullscreen" title="Pantalla Completa / Fullscreen" data-i18n-title="btn_fullscreen">
                        <i data-lucide="maximize-2"></i>
                    </button>
                    <button class="btn" id="btn-theme-toggle" title="Cambiar Tema">
                        <i data-lucide="sun"></i>
                    </button>
                </div>
            </div>
            ...
            <div class="header-bottom-row">
                ...
                <nav class="nav-tabs">
                    <button class="nav-tab active" data-view="dashboard">
                        <i data-lucide="layout-dashboard"></i> <span data-i18n="nav_dashboard">Dashboard</span>
                    </button>
                    <button class="nav-tab" data-view="gantt">
                        <i data-lucide="milestone"></i> <span data-i18n="nav_gantt">Gantt Matrix</span>
                    </button>
                    <button class="nav-tab" data-view="kanban">
                        <i data-lucide="kanban"></i> <span data-i18n="nav_kanban">Kanban</span>
                    </button>
                    <button class="nav-tab" data-view="table">
                        <i data-lucide="table-properties"></i> <span data-i18n="nav_tasks">Tareas</span>
                    </button>
                    <button class="nav-tab" data-view="projects">
                        <i data-lucide="folder-kanban"></i> <span data-i18n="nav_projects">Proyectos</span>
                    </button>
                    <button class="nav-tab" data-view="users" id="tab-users" style="display: none;">
                        <i data-lucide="users"></i> <span data-i18n="nav_users">Usuarios</span>
                    </button>
                </nav>

                <!-- Actions -->
                <div class="action-buttons">
                    <button class="btn" id="btn-import-trigger" title="Importar Respaldo JSON">
                        <i data-lucide="upload"></i> <span data-i18n="btn_import">Importar</span>
                    </button>
                    <input type="file" id="json-file-input" style="display: none;" accept=".json">
                    <button class="btn" id="btn-export-json" title="Exportar Respaldo JSON">
                        <i data-lucide="file-json"></i> <span data-i18n="btn_backup">Respaldo JSON</span>
                    </button>
        ...
        <!-- Filters Toolbar (Hidden in Print) -->
        ...
        <main class="view-container">
            ...
            <!-- 1. Dashboard Panel -->
            <div id="dashboard-panel" class="view-panel active">
                    ...
                    <div class="chart-card">
                        ...
                        <div class="chart-content">
                            ...
                            <div id="donut-chart-wrapper" style="width: 180px; height: 180px; position: relative;">
                                <svg id="status-donut-svg" width="100%" height="100%" viewBox="0 0 42 42" class="donut">
                                    <circle class="donut-hole" cx="21" cy="21" r="15.915" fill="transparent"></circle>
                                    <circle class="donut-ring" cx="21" cy="21" r="15.915" fill="transparent" stroke="var(--border)" stroke-width="4"></circle>
                                    <circle id="donut-segment-completed" cx="21" cy="21" r="15.915" fill="transparent" stroke="#10b981" stroke-width="4" stroke-dasharray="0 100" stroke-dashoffset="0"></circle>
                                    <circle id="donut-segment-progress" cx="21" cy="21" r="15.915" fill="transparent" stroke="#f59e0b" stroke-width="4" stroke-dasharray="0 100" stroke-dashoffset="0"></circle>
                                    <circle id="donut-segment-blocked" cx="21" cy="21" r="15.915" fill="transparent" stroke="#ef4444" stroke-width="4" stroke-dasharray="0 100" stroke-dashoffset="0"></circle>
                                    <circle id="donut-segment-pending" cx="21" cy="21" r="15.915" fill="transparent" stroke="#64748b" stroke-width="4" stroke-dasharray="0 100" stroke-dashoffset="0"></circle>
                                </svg>
            ...
            <!-- 1.5. Projects Panel -->
            <div id="projects-panel" class="view-panel">
                <div class="projects-grid" id="projects-container">
                    <!-- Project Cards generated dynamically by JS -->
                </div>
            </div>

            <!-- Users Panel (ABM) -->
            <div id="users-panel" class="view-panel">
            ...
            <!-- 2. Gantt Matrix Panel -->
            <div id="gantt-panel" class="view-panel">
                <!-- Gantt Control Sub-toolbar (Hidden in print) -->
                <div class="toolbar" style="margin-bottom: 0.75rem; padding: 0.5rem 1rem; display: flex; align-items: center; justify-content: space-between;">
                    <!-- Leyenda Plan vs Real -->
                ...
                <div class="gantt-container">
                    <table class="gantt-table" id="gantt-table-element">
                        ...
                        <thead>
                            ...
                            <tr id="gantt-week-row">
                                <!-- Weeks Headers inserted dynamically -->
                            </tr>
                        </thead>
                        <tbody id="gantt-body">
                            <!-- Tasks rows inserted dynamically -->
                        </tbody>
                    </table>
                </div>
            </div>
            ...
            <!-- 3. Kanban Panel -->
            <div id="kanban-panel" class="view-panel">
            ...
            <!-- 4. Table Panel -->
            <div id="table-panel" class="view-panel">
                <div class="gantt-container" style="max-height: calc(100vh - 250px);">
                    <table class="gantt-table">
                        <thead>
                            <tr>
    ...
    <!-- Inject data.js first, then app.js -->
